...
print("Powered by TFL Open Data's APIs\nPlease wait, program is loading...")
time.sleep(3)
def clear():
    if os.name == 'nt':
        os.system("cls")
    ...
    try:
        ...
        while flag:
            ...
            if option == 1:
                ...
                STOP_POINT_ID = "940GZZLUECT"  # Earl's Court
                ...
                print("This version of the TFL/London Underground Time board is made to see the arrivals of trains in any London Underground Station. In particular, this version is at a station level and is exactly what you would see at the entrance of the station.")
                input("Press enter to return to CONFIGURATION MENU")
    except Exception as e:
