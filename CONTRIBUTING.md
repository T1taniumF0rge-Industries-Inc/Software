...
> - Defusal (making deadly programs non deadly) or removal of deadly codes will result in a warning. Keep in mind that these codes are not specifically meant to be run, could be for learning, besides, there are warnings everywhere. Read [this](https://github.com/T1taniumF0rge-Industries-Inc/Software/blob/main/.github/faq.md#why-are-you-hosting-deadly-programs-with-little-to-no-guardrails) section of the FAQ for more information.
