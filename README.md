![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/T1taniumF0rge/software?label=Latest%20Release%3A) &nbsp; ![GitHub last commit](https://img.shields.io/github/last-commit/T1taniumF0rge/software?color=red&label=Last%20Commit%3A) &nbsp;![GitHub commit activity](https://img.shields.io/github/commit-activity/w/T1taniumF0rge/software?color=blueviolet&label=Commit%20Activity%3A)
 &nbsp;![GitHub repo size](https://img.shields.io/github/repo-size/T1taniumF0rge/Software?color=green&label=Repository%20Size%3A) &nbsp;![GitHub commit activity](https://img.shields.io/badge/Clone%20Size-41.2GB-066990) &nbsp; ![GitHub commit activity](https://img.shields.io/badge/Repository%20Status-Busy-blue) &nbsp;

# [`Software`] Repository
> [!IMPORTANT]
> ### /!\ REPOSITORY MIGRATION FROM GAMERSOFTWARE CORPORATION® & MIDNIGHT_G0LDX CORPORATION® TO THE TITAN1UM™ & T1TANIUMF0RGE INDUSTRIES® INCORPORATED IN PROGRESS... REPOSITORY COMMITS WILL NOW FOCUS ON MIGRATION PROCESS TASKS UNTIL MIGRATION IS OVER!
...
> [!NOTE]
> The ["Programs.md (program chart)"](https://github.com/T1taniumF0rge/Software/blob/Main/Programs.md) file has most but not every single resource available in the repository. Feel free to open an issue if you are unable to find what you want!

## [`PySoft:`]
This is **where** I and Okmeque1 will be *storing all* of ***our*** Python codes and programs.

*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/PySoft)
...
*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/VBSoft)

## [`HTMLSoft:`]

This is **where** I will be *storing all* of ***my*** HTML (HyperText Markup Language) codes and programs.

*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/HTMLSoft)
...
> [!TIP]
> 
> It is recommended to have [Arduino IDE](https://www.arduino.cc/en/software) installed on your PC as a lot of programs will require it. Please check the ["Programs.md"](https://github.com/T1taniumF0rge/Software/blob/Main/Programs.md) file for informations about programs requiring Arduino IDE.

*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/CPPSoft)

## [`BatchSoft:`]

This is **where** I will be *storing all* of ***my*** Windows Batchfile codes and programs.

*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/BatchSoft)
...
*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/InstallerSoft)

## [`MinecraftSoft:`]

This is **where** I will be *storing all* of ***my*** Minecraft modpacks.

*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/MinecraftSoft)
...
*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/MovieSoft)
...
*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/HackSoft)
...
*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/RepoSoft)
...
*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/OkmequeSoft)

## [`OfficeSoft:`]

This is **where** I will be *storing all* of the ***Microsoft office files I use at work.*** (Word templates, etc)

*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/OfficeSoft)
...
*For* **direct access**, [click here!](https://github.com/T1taniumF0rge/Software/tree/Main/PictureSoft)
...
>
>The main coding language in this repository is Python ([PySoft](https://github.com/T1taniumF0rge/Software/tree/Main/PySoft)), although we do have secondary coding languages like C++ ([CPPSoft](https://github.com/T1taniumF0rge/Software/tree/Main/CPPSoft)), Windows Batchfile ([BatchSoft](https://github.com/T1taniumF0rge/Software/tree/Main/BatchSoft)), Windows Visual Basic Script ([VBSoft](https://github.com/T1taniumF0rge/Software/tree/Main/VBSoft)), HyperText Markup Language ([HTMLSoft](https://github.com/T1taniumF0rge/Software/tree/Main/HTMLSoft)), hacks with varying languages in HackSoft ([HackSoft](https://github.com/T1taniumF0rge/Software/tree/Main/HackSoft)), Java (coming soon), JavaScript (coming soon), possibly TypeScript (coming soon), etc...

## Program Chart:

For easy access to all working files and programs in this repository, use the [program chart (programs.md)](https://github.com/T1taniumF0rge/Software/tree/Main/Programs.md).
