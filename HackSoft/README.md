...
Welcome to `Software`'s HackSoft section, where I will be storing all of my hacks for various things, such as games but other applications potentially as well.
